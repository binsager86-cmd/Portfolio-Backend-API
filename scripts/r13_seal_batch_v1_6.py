...
def main() -> None:
    files = [
        "scripts/r13_findings_of_record_v1_1.py",
        "scripts/r14_design_spec_v1.py",
        "scripts/r13_seal_batch_v1_6.py",
    ...
    payload: dict[str, Any] = {
        "version_id": "R13_CREATED_FILES_MANIFEST_V1_6",
    ...
    out_json = REVIEW / "r13_created_files_manifest_v1_6.json"
    out_sha = REVIEW / "r13_created_files_manifest_v1_6.sha256"
    out_json.write_text(json.dumps(payload, ensure_ascii=True, indent=2, sort_keys=True) + "\n", encoding="utf-8")
    manifest_hash = sha256_file(out_json)
    out_sha.write_text(f"{manifest_hash}  artifacts/preview1a_prestart/review_final/r13_created_files_manifest_v1_6.json\n", encoding="utf-8")
    print("R13_SEAL_BATCH_V1_6_COMPLETE")
