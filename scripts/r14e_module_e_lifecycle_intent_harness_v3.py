...
RUN_NONCE = "2026-07-14T17:11:11.5514073Z"
...
def main() -> None:
    ...
    out_interface = REVIEW / "r14e_module_e_interface_conformance_v3.json"
    out_evidence = REVIEW / "r14e_module_e_test_evidence_v3.json"
    out_report = REVIEW / "r14e_module_e_implementation_report_v3.md"
    out_sha = REVIEW / "r14e_module_e_artifacts_v3.sha256"
    harness_db = REVIEW / "r14e_module_e_harness_surface_v3.db"
    ...
    evidence_payload = {
        "version_id": "R14E_MODULE_E_TEST_EVIDENCE_V3",
        "freeze_v2_attestation": attest,
        "run_nonce": RUN_NONCE,
    ...
    lines = [
        f"{sha256_file(out_interface)}  artifacts/preview1a_prestart/review_final/r14e_module_e_interface_conformance_v3.json",
        f"{sha256_file(out_evidence)}  artifacts/preview1a_prestart/review_final/r14e_module_e_test_evidence_v3.json",
        f"{sha256_file(out_report)}  artifacts/preview1a_prestart/review_final/r14e_module_e_implementation_report_v3.md",
    ]
    out_sha.write_text("\n".join(lines) + "\n", encoding="utf-8")

    print("R14E_MODULE_E_HARNESS_V3_COMPLETE")
