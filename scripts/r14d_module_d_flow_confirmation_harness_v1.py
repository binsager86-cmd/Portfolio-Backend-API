...
HARNESS_DB = REVIEW / "r14d_module_d_harness_surface_v1.db"
...
def main() -> None:
    ...
    interface_json = REVIEW / "r14d_module_d_interface_conformance_v1.json"
    evidence_json = REVIEW / "r14d_module_d_test_evidence_v1.json"
    report_md = REVIEW / "r14d_module_d_implementation_report_v1.md"
    harness_log = REVIEW / "r14d_module_d_harness_output_v1.log"
    sidecar = REVIEW / "r14d_module_d_daily_ledger_chain_v1.sha256"
        ...
        for day in rows:
            ...
            base_out = base.evaluate(
                ...
                volatility_regime_state={
                    ...
                    "invalidation_rule_params": {"n_sessions": 5},
    ...
    interface_payload = {
        "version_id": "R14D_MODULE_D_INTERFACE_CONFORMANCE_V1",
        "module_boundary": {
    ...
    evidence_payload = {
        "version_id": "R14D_MODULE_D_TEST_EVIDENCE_V1",
    ...
    print("R14D_MODULE_D_FLOW_CONFIRMATION_HARNESS_V1_COMPLETE")
