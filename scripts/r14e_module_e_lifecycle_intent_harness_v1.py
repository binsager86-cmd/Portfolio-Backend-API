...
def main() -> None:
    ...
    out_interface = REVIEW / "r14e_module_e_interface_conformance_v1.json"
    out_evidence = REVIEW / "r14e_module_e_test_evidence_v1.json"
    out_report = REVIEW / "r14e_module_e_implementation_report_v1.md"
    out_sha = REVIEW / "r14e_module_e_artifacts_v1.sha256"
    ...
    lines = [
        f"{sha256_file(out_interface)}  artifacts/preview1a_prestart/review_final/r14e_module_e_interface_conformance_v1.json",
        f"{sha256_file(out_evidence)}  artifacts/preview1a_prestart/review_final/r14e_module_e_test_evidence_v1.json",
        f"{sha256_file(out_report)}  artifacts/preview1a_prestart/review_final/r14e_module_e_implementation_report_v1.md",
    ]
    out_sha.write_text("\n".join(lines) + "\n", encoding="utf-8")

    print("R14E_MODULE_E_HARNESS_V1_COMPLETE")
